      ...
      <MotionConfig reducedMotion="user">
        ...
        >
          ...
          >
            ...
            {/* Image column: the school facade grounds the page in a real
               place from the first beat (Show, Don't Tell). Modern colour
               photo, no period treatment. A thin gold ring inset keeps it in
               the Gold-as-Detail family; the ring is decorative linework only,
               legal on this light ground. */}
            <m.div
              variants={itemVariants}
            ...
            >
              <div className="relative aspect-[5/4] overflow-hidden rounded-2xl border border-border bg-muted shadow-sm">
                <Image
                  src="/school-front-cropped.png"
                  alt="The facade of St. Joseph's Academy of Malinao, showing its 1947 founding year and Selfless, Just, Achiever banner"
                  fill
                  priority
